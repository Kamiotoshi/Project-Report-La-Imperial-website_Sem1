    ...
    <div class="container-fluid">
            <div class="row header_top">
                ...
                <div class="col-4 align-items-center d-flex justify-content-end">
                    <a href="login&register.html"><i class="fas fa-user icon-header"></i></a>
                ...
                <ul class="navbar-nav" id="nav-bar">
                    <li>
                        ...
                        <div class="collapse navbar-collapse category-list openTab" id="fridgesDetail">
                            <div class="all items"><a href="product.html">Tất cả tủ lạnh</a></div>
                            <div class="items"><a href="product.html">Tủ lạnh 2 cánh</a></div>
                            <div class="items"><a href="product.html">Tủ lạnh mini</a></div>
                            <div class="items"><a href="product.html">Tủ lạnh 1 cánh</a></div>
                            <div class="items"><a href="product.html">Tủ đông</a></div>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="collapse navbar-collapse category-list openTab" id="laundryDetail">
                            <div class="all items"><a href="product.html">Tất cả máy giặt</a></div>
                            <div class="items"><a href="product.html">Máy giặt cửa trước</a></div>
                            <div class="items"><a href="product.html">Mắt giặt cửa trên</a></div>
                            <div class="items"><a href="product.html">Máy giặt sấy</a></div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="collapse navbar-collapse category-list openTab" id="conditioningDetail">
                            <div class="all items" class="all"><a href="product.html">Tất cả điều hòa</a></div>
